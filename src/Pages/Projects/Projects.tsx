        ...
        <section className="flex justify-center">
            <section className="my-5 flex items-center flex-col min-h-full bg-[rgb(21,41,78)]">
                <section className="m-5 flex flex-col lg:flex-row">
                    <Project link="https://connect4clone.herokuapp.com/" arrayOfTags={["TS", "React", "GraphQl"]} imageSrc={team} projectDescription="This is a Connect 4 clone that supports both online and local multiplayer." projectTitle="Connect4 Clone"/>
